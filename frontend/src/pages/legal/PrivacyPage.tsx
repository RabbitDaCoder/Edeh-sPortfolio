...
export default function PrivacyPage() {
  return (
    <LegalLayout
      ...
      description="How Edeh Chinedu Daniel collects, uses, and protects your information on this portfolio platform."
      lastUpdated="March 2026"
    >
      {/* Intro */}
      <LP>
        This Privacy Policy explains how Edeh Chinedu Daniel (&quot;I&quot;,
        &quot;me&quot;, &quot;my&quot;) collects, uses, and protects information
        when you visit this portfolio, read my blog, purchase books, or contact
        me through this platform.
      </LP>
      <LP>
        I built this platform myself and I take your privacy seriously. I do not
        sell your data, I do not run advertising, and I collect only what is
        necessary to run the platform.
      </LP>

      <LegalSection number="01" heading="Information I collect">
        <LP>
          Depending on how you use this platform, I may collect the following:
        </LP>
        <LList
          items={[
        ...
        <LCallout>
          <LP>
            I do not use third-party advertising networks, tracking pixels, or
            data brokers. This portfolio runs on advertising-free infrastructure
            and does not feed your behaviour into any AI training pipeline.
          </LP>
        </LCallout>
      </LegalSection>

      <LegalSection number="02" heading="How I use your information">
        <LP>
          Information you provide is used only for the purpose you provided it:
        </LP>
        <LList
          items={[
      ...
      <LegalSection number="03" heading="Cookies and tracking">
        <LP>
          This platform uses a small number of technical cookies necessary for
          the site to function, and one analytics tool (PostHog) that uses a
          first-party cookie.
        </LP>
        <LList
          items={[
      ...
      <LegalSection number="04" heading="Data storage and security">
        <LP>
          Your data is stored on secure servers hosted on Render (backend) and
          managed via PostgreSQL. I use industry-standard security practices:
        </LP>
        <LList
          items={[
        ...
        />
        <LP>
          I retain contact enquiry data for up to 12 months and then delete it.
          Newsletter subscriber data is deleted within 30 days of unsubscribing.
        </LP>
      </LegalSection>

      <LegalSection number="05" heading="Third-party services">
        <LP>
          This platform integrates with the following third-party services. Each
      ...
      <LegalSection number="06" heading="Your rights">
        ...
        />
        <LP>
          To exercise any of these rights, email me at <LEmail />. I will
          respond within 14 days.
        </LP>
      </LegalSection>

      <LegalSection number="07" heading="Children's privacy">
        <LP>
          This platform is not directed at children under the age of 13. I do
          not knowingly collect data from children. If you believe a child has
          submitted data through this platform, please contact me at <LEmail />{" "}
