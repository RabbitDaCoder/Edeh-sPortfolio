...
export const FeaturedPost = ({ post }) => {
    ...
    return (_jsxs(motion.article, { initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, onClick: () => navigate(`/blog/${post.slug}`), className: "group cursor-pointer border border-border rounded-md overflow-hidden hover:border-text-muted/40 transition-colors", children: [_jsxs("div", { className: "w-full h-64 md:h-80 bg-surface flex items-center justify-center relative overflow-hidden", children: [post.coverImage ? (_jsx("img", { src: post.coverImage, alt: post.title, className: "absolute inset-0 w-full h-full object-cover", loading: "lazy" })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-accent/5 to-transparent" }), _jsx("span", { className: "text-display-lg font-serif text-text-muted/20 select-none", children: "Featured" })] })), _jsx(Badge, { variant: "default", className: "absolute top-4 left-4 shadow-sm backdrop-blur-sm", children: "Featured" })] }), _jsxs("div", { className: "p-6 md:p-8 space-y-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Badge, { variant: "default", className: "text-xs", children: post.category }), _jsx("span", { className: "text-xs text-text-muted font-mono", children: post.readTime }), _jsx("span", { className: "text-xs text-text-muted font-mono", children: new Date(post.date).toLocaleDateString("en-US", {
                                    month: "short",
                                    day: "numeric",
                                    year: "numeric",
