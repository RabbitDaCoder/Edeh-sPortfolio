...
function MobileWork({ activeCard, projects }) {
  ...
  return _jsx("section", {
    id: "work",
    className:
      "relative w-full py-10 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 bg-surface/30",
    children: _jsxs("div", {
      ...
      children: [
        _jsxs("div", {
          children: [
            _jsx("span", {
              className:
                "font-mono text-label text-text-muted uppercase tracking-widest",
              children: "03 \u2014 Work",
            }),
            _jsx("h2", {
              className: "font-serif text-display-xl mt-2",
        ...
        _jsx("div", {
          ...
          children: _jsx("div", {
            ...
            children: projects.map((p) =>
              _jsx(MobileProjectCard, { project: p }, p.name),
            ),
          }),
        }),
        _jsx("div", {
          className: "flex justify-center gap-2",
          children: projects.map((_, i) =>
            _jsx(
              "span",
              {
                className: `w-2 h-2 rounded-full transition-colors ${i === selected ? "bg-accent" : "border border-border"}`,
              },
              i,
            ),
          ),
...
export const WorkSection = () => {
  ...
  if (count < 2) {
    return _jsx("section", {
      ...
      id: "work",
      className:
        "relative w-full py-10 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16 bg-surface/30",
      children: _jsxs("div", {
        className: "max-w-6xl mx-auto space-y-8",
        children: [
          _jsxs("div", {
          ...
          projects[0] &&
            _jsx("div", {
              className: "relative w-full h-[70vh] max-h-[540px]",
              children: _jsx(ProjectCard, {
                project: projects[0],
                cardRef: cardRefs[0],
                variant: "top",
                index: 0,
  ...
  return _jsx("div", {
    ...
    children: _jsxs("div", {
      className:
        "h-screen w-full flex flex-col justify-center overflow-hidden px-4 md:px-8 lg:px-16",
      children: [
        _jsxs("div", {
          ref: headerRef,
                ...
                _jsx("div", {
                  ...
                  children: projects.map((_, i) =>
                    _jsx(
                      motion.span,
                      {
                        className: `w-2 h-2 rounded-full ${i <= activeCard ? "bg-accent" : "border border-border"}`,
                        layout: true,
                        transition: {
                          type: "spring",
                          stiffness: 500,
        ...
        _jsx("div", {
          className: "relative w-full flex-1 flex items-center min-h-0",
          children: _jsx("div", {
            className: "relative w-full h-[70vh] max-h-[540px]",
            children: [...projects].reverse().map((p, reverseIdx) => {
        ...
        _jsx("div", {
          ...
          children: _jsxs(motion.div, {
            ...
            children: [
              _jsx(MousePointer, { size: 14, strokeWidth: 1.5 }),
              _jsx("span", {
        ...
        _jsxs("div", {
          ref: ctaRef,
          className:
            "absolute bottom-12 right-4 md:right-8 lg:right-16 opacity-0 translate-y-[10px]",
          children: [
            _jsx("span", {
              className:
                "block font-mono text-label text-text-muted uppercase tracking-widest mb-2",
              children: "All projects on GitHub",
            }),
            personal?.github &&
              _jsxs(Button, {
                variant: "ghost",
                ...
                children: [
                  _jsx(ArrowUpRight, { size: 14, strokeWidth: 1.5 }),
                  "View GitHub",
                ],
              }),
          ],
