...
function TestimonialCard({ name, designation, company, quote, initials }) {
  return _jsxs(Card, {
    ...
    children: [
      _jsxs("p", {
        className: "text-text-muted text-sm leading-relaxed flex-1 italic",
        children: ["\u201C", quote, "\u201D"],
      }),
      _jsxs("div", {
        ...
        children: [
          _jsx("div", {
            className:
              "w-9 h-9 rounded-full bg-surface border border-border flex items-center justify-center text-xs font-mono text-text-muted",
            children: initials,
          }),
          _jsxs("div", {
            children: [
  ...
  return _jsx(Section, {
    ...
    children: _jsxs("div", {
      ...
      children: [
        ...
        _jsx("div", {
          className: "md:hidden",
          children: _jsx(MobileTestimonials, { items: testimonials }),
        }),
      ],
    }),
  });
