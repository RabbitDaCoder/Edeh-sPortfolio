  ...
  return _jsxs(Section, {
    ...
    children: [
        ...
        children: _jsxs("div", {
          ...
          children: [
            _jsx(Badge, {
              variant: "pulse",
              className: "text-xs",
              children: personal.availability,
            }),
            _jsx("h1", {
              ref: headlineRef,
              className:
                "text-display-2xl font-serif text-text-primary leading-[0.9] tracking-tight break-words",
              children: displayName
                ...
                .map((part, i, arr) =>
                  _jsx(
                    "span",
                    {
                      className: `hero-line block ${i === arr.length - 1 ? "text-text-muted" : ""}`,
                      children: part,
                    },
                    part,
                  ),
      ...
      _jsx("div", {
        ...
        children: _jsx(PolaroidCarousel, {}),
      }),
      _jsx(motion.div, {
        animate: { y: [0, 10, 0] },
        ...
        children: _jsx("div", {
          className:
            "w-6 h-10 border border-text-muted rounded-full flex items-center justify-center",
          children: _jsx("div", {
